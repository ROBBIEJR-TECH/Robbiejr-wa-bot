const {
  ...
  const ownerNumber = ['254718606619']
  ...
  console.log('ROBBIEJR V.1 connected to whatsapp ✅')
  ...
  ╠═════════════════╣
  ║      ROBBIEJR V1              
  ║ > © ᴘᴏᴡᴇʀᴇᴅ ʙʏ your ROBBIEJR      
  ╚═════════════════╝
`;
  conn.sendMessage(ownerNumber + "@s.whatsapp.net", { image: { url: `https://i.ibb.co/CKQQg4f5/shaban-md.jpg` }, caption: up })
